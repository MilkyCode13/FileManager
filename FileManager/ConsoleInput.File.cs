...
namespace FileManager
{
    ...
    {
        /// <summary>
        /// Gets auto completion list for file paths.
        /// </summary>
        /// <param name="input">String to complete.</param>
        /// <returns>Completed string variants.</returns>
        private string[] GetAutoCompletionListFile(string input)
        {
            ...
            try
            {
                return parentDir.EnumerateDirectories()
                    ...
                    .Concat(parentDir.EnumerateFiles().Select(file => parentPath + file.Name))
